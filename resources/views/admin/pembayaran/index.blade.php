                ...
                @forelse ($transaksis as $t)
                    <tr class="border-b hover:bg-purple-50 transition">
                        ...
                        <td class="p-3 text-center space-x-2">
                            ...
                            {{-- TOMBOL BAYAR --}}
                            @if ($t->status != 'dibayar')
                                <form action="{{ route('admin.pembayaran.bayar', $t->id) }}" method="POST" class="inline">
                                    @csrf
                                    <button class="px-3 py-1 bg-green-600 text-white rounded-lg hover:bg-green-700 text-xs">
                                        ✔ Bayar
                                    </button>
                                </form>
